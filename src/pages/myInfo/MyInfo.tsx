...
const MyInfo = () => {
  ...
  const myInfoTabInfo = [
    {
      idx: 0,
      url: '/images/home_white.svg',
      clickedUrl: '/images/home_purple.svg',
      info: '강의실',
    },
    {
      idx: 1,
      url: '/images/book_white.svg',
      clickedUrl: '/images/book_purple.svg',
      info: '개설 강의 관리',
    },
    {
      idx: 2,
      url: '/images/todo_white.svg',
      clickedUrl: '/images/todo_purple.svg',
      info: '작성 글 관리',
    },
    {
      idx: 3,
      url: '/images/money_white.svg',
      clickedUrl: '/images/money_purple.svg',
      info: '예산 신청 내역',
    },
    {
      idx: 4,
      url: '/images/user_white.svg',
      clickedUrl: '/images/user_purple.svg',
      info: '내정보',
    },
  ];
