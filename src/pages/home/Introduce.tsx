          ...
          <HeroContent $zIndex={2} $position="absolute" $top="35%" $left="5%">
            ...
            <HeroCopyBox width="600px">
              <HeroCopy color="wh" $whiteSpace="wrap" $lineHeight={2} fontSize="xl">
                ...
                <br />그 규모가 방대하고, 생성 주기도 짧고, 형태도 수치 데이터뿐 아니라 <br />{' '}
                문자와 영상 데이터를 포함하는 대규모 데이터를 말합니다.
                <br /> 빅데이터는 과거에 비해 데이터가 폭증하였고 <br /> 데이터의 종류도 다양해져
                사람들의 행동은 물론이고 <br /> 위치정보와 SNS를 통해 생각과 의견까지 분석하고
                예측할 수 있습니다.
              </HeroCopy>
            </HeroCopyBox>
          </HeroContent>
        ...
        <AboutContent width="60%" $padding="60px 30px" height="100vh">
          ...
          <Div $margin="30px 0 0 0" width="100%">
            <P color="wh" $letterSpacing="3px" $lineHeight={2} $whiteSpace="normal">
              ...
              <br />
              IBAS는 4차산업 혁명 시대의 흐름에 맞추어 필요한 빅데이터 역량을 갖춘 인재를 육성해
              나가자는 취지에서 만들어진 동아리입니다. 주로 데이터 직무(산업)에 관심있는 학생들이
              모여 빅데이터 분석에 필요한 지식을 습득, 활용해 나가며 빅데이터 역량을 갖추고 사회에
              나갈 수 있도록 학습하는 빅데이터 학술동아리 입니다.
            </P>
          </Div>
          <Div $margin="40px 0">
