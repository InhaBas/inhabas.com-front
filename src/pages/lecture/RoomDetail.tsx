          ...
          <Div width="100%" $margin="0 0 30px 0">
            ...
            <Div $margin="50px 0 ">
              <P $whiteSpace="pre-wrap" $lineHeight={1.5}>
                작성일 기준 업로드 가능한 파일 확장자는 아래와 같습니다. .xlsx .xls image/* .doc
                .docx .ppt .pptx .txt .pdf .zip .csv 물론 과제 제출에는 .py .java 도 제출
                가능합니다만, 일부는 기능에 따라서 이미지만 업로드 가능한 경우가 있습니다. 꼭 필요한
                파일의 업로드가 제한되는 경우 회장단을 통해 it 부서에 문의 주시면 됩니다.
              </P>
            </Div>
