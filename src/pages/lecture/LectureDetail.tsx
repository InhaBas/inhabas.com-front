      ...
      <Container>
        <LectureContent width="100%" $margin="0 0 30px 0">
          ...
          >
            ...
            <Div $padding="20px">
              <P $lineHeight={1.5}>
                R studio의 기능과 문법, tidyverse의 패키지를 배우고 iris, titanic, gapminder 등과
                같은 데이터를 활용한 간단한 분석까지를 목표로 합니다.
              </P>
            </Div>
          </Div>
          ...
          >
            ...
            <Div $padding="20px">
              <P $whiteSpace="pre-wrap" $lineHeight={1.5}>
                R studio의 기능과 문법, tidyverse의 패키지를 배우고 iris, titanic, gapminder 등과
                같은 데이터를 활용한 간단한 분석까지를 목표로 합니다. 매 주 금요일 오후 4~6시에
                진행할 예정이며, 강의 녹화본을 따로 올려드리겠습니다.
              </P>
            </Div>
          </Div>
          ...
          >
            ...
            <Div $padding="20px">
              <P $lineHeight={1.5}>
                https://zoom.us/j/7672419454?pwd=enBkMkpwZDVDbm1DamxtbmtrRVh2QT09
              </P>
            </Div>
          </Div>
